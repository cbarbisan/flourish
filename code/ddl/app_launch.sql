...
-- for the first invoice generated by this application that used
-- the specified invoice frequency. So for example, if the first
-- time the application generated monthly invoices was for the
-- month of December 2023, the launch date for all invoices
-- generated monthly will be 2023-12-01.
-- 
...
-- identified in the non_invoiced_session table. This will guarantee
-- their inclusion on an invoice once they are eligible (e.g. once the
...
-- a bi-weekly invoice may not start on the first day of the month. 
-- That is why we have different launch dates for different invoice
-- frequencies.
